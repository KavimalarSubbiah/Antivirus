...
int scanCallback(
    ...
    case CALLBACK_MSG_SCAN_FINISHED:
        printf("Scan finished for file: %s\n", filePath);  // Print filePath when scan finishes
        break;
...
int main(int argc, char* argv[]) {
    ...
    const char directory_path[] = "/home/administrator/SEM-7 PROJECTS/Malware-Detection-ML-Model/How to create YOUR own Antivirus software/rules";  // Update this path
